        ...
        while True:
            ...
            if 'Messages' in response:
                ...
                try:
                    ...
                    print(
                        f"Received an empty or non-JSON message: {message['Body']}")
                    continue
                ...
                if s3_location and operation:
                    ...
                    print(f"Received task with s3_location: {
                          s3_location}, operation: {operation}")
        ...
        while True:
            ...
            if rank == 0:
                ...
                s3_client.upload_file(
                    result_file_name, bucket_name, result_file_name)
